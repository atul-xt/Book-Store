    ...
    <div className='px-4 lg:px-24 bg-teal-100 flex items-center'>
        <div className='flex w-full flex-col md:flex-row justify-between items-center gap-12 py-40'>
            <div className='md:w-1/2 h-full space-y-8 '>
                ...
                <p className='md:w-4/5 '>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Officia unde ratione repudiandae, quasi vel totam est temporibus architecto nemo blanditiis!</p>
                <div>
